...
const LoginForm = ({ onLogin }) => {
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', background: '#f0f2f5' }}>
            <Card style={{ width: 400, padding: '20px', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.1)' }} title={<h2 style={{ textAlign: 'center' }}>Se connecter</h2>}>
                ...
                <div style={{ marginTop: '10px', textAlign: 'center' }}>
                    <Text onClick={() => navigate('/register')} style={{ cursor: 'pointer', color: '#1890ff' }}>
                        Pas encore inscrit ? Créez un compte
                    </Text>
                    <br />
                    <Text onClick={() => navigate('/forgot-password')} style={{ cursor: 'pointer', color: '#1890ff' }}>
                        Mot de passe oublié ?
                    </Text>
                </div>
            </Card>
